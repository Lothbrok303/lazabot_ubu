...
use super::{BrowserFingerprint, FingerprintSpoofer, BehaviorSimulator, simulate_typing};
...
impl StealthClient {
    ...
    pub async fn stealth_request(
        ...
        // Make the request
        let response = self.base_client.request(
            method,
            url,
            Some(headers),
            body,
    ...
    pub async fn stealth_get(
        ...
        self.stealth_request(Method::GET, url, custom_headers, None, proxy).await
    }
    ...
    pub async fn stealth_post(
        ...
        self.stealth_request(Method::POST, url, custom_headers, Some(body), proxy).await
    }
