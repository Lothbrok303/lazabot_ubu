...
impl BrowserFingerprint {
    ...
    pub fn generate() -> Self {
        ...
        let screen_resolution = screen_resolutions[rng.gen_range(0..screen_resolutions.len())].to_string();
        ...
        let do_not_track = do_not_track_values[rng.gen_range(0..do_not_track_values.len())].to_string();
        ...
        let hardware_concurrency = hardware_concurrency[rng.gen_range(0..hardware_concurrency.len())];
